...
//
//              Group13: router with RV64I pipeline datapath IP
//
///////////////////////////////////////////////////////////////////////////////
...
`define PIPE_BLOCK_ADDR_WIDTH           19
`define PIPE_REG_ADDR_WIDTH             4
...
`define PIPE_BLOCK_ADDR           19'h00008
...
`define PIPE_IMEM_INTERACT     4'h0
`define PIPE_IMEM_WRITE        4'h1
`define PIPE_IMEM_RW_ADDRESS   4'h2
`define PIPE_IMEM_WDATA        4'h3
`define PIPE_DMEM_INTERACT     4'h4
`define PIPE_DMEM_WRITE        4'h5
`define PIPE_DMEM_RW_ADDRESS   4'h6
`define PIPE_DMEM_WDATA_UPPER  4'h7
`define PIPE_DMEM_WDATA_LOWER  4'h8
`define PIPE_IMEM_RDATA        4'h9
`define PIPE_DMEM_RDATA_UPPER  4'ha
`define PIPE_DMEM_RDATA_LOWER  4'hb
