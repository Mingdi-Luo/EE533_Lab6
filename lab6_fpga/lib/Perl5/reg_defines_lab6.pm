...
sub DEVICE_PROJ_DESC () { "Group13: router with RV64I pipeline datapath IP"; }
...
sub PIPE_IMEM_INTERACT_REG ()      { 0x2000200;}
sub PIPE_IMEM_WRITE_REG ()         { 0x2000204;}
sub PIPE_IMEM_RW_ADDRESS_REG ()    { 0x2000208;}
sub PIPE_IMEM_WDATA_REG ()         { 0x200020c;}
sub PIPE_DMEM_INTERACT_REG ()      { 0x2000210;}
sub PIPE_DMEM_WRITE_REG ()         { 0x2000214;}
sub PIPE_DMEM_RW_ADDRESS_REG ()    { 0x2000218;}
sub PIPE_DMEM_WDATA_UPPER_REG ()   { 0x200021c;}
sub PIPE_DMEM_WDATA_LOWER_REG ()   { 0x2000220;}
sub PIPE_IMEM_RDATA_REG ()         { 0x2000224;}
sub PIPE_DMEM_RDATA_UPPER_REG ()   { 0x2000228;}
sub PIPE_DMEM_RDATA_LOWER_REG ()   { 0x200022c;}
