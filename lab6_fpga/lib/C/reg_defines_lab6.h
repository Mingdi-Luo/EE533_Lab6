 ...
 * Project: Pipeline router (lab6)
 * Description: Group13: router with RV64I pipeline datapath IP
 *
 ********************************************************/
...
#define DEVICE_PROJ_DESC   "Group13: router with RV64I pipeline datapath IP"
...
#define PIPE_BASE_ADDR           0x2000200
...
// Name: rv64i_pipeline (PIPE)
// Description: Registers for RV64I Pipeline Processor debug interface
// File: projects/lab6/include/rv64i_pipeline.xml
#define PIPE_IMEM_INTERACT_REG      0x2000200
#define PIPE_IMEM_WRITE_REG         0x2000204
#define PIPE_IMEM_RW_ADDRESS_REG    0x2000208
#define PIPE_IMEM_WDATA_REG         0x200020c
#define PIPE_DMEM_INTERACT_REG      0x2000210
#define PIPE_DMEM_WRITE_REG         0x2000214
#define PIPE_DMEM_RW_ADDRESS_REG    0x2000218
#define PIPE_DMEM_WDATA_UPPER_REG   0x200021c
#define PIPE_DMEM_WDATA_LOWER_REG   0x2000220
#define PIPE_IMEM_RDATA_REG         0x2000224
#define PIPE_DMEM_RDATA_UPPER_REG   0x2000228
#define PIPE_DMEM_RDATA_LOWER_REG   0x200022c
